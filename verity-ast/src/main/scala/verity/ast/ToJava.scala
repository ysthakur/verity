...
//   given ToJava[TextRange] = _ => ""

//   given [T <: AnyVal]: ToJava[T] = _ => ""

//   given ToJava[String] = Predef.identity

//   given [T : ToJava]: ToJava[Seq[T]] = seq => seq.view.map(_.toJava).mkString("") //todo put a space between them?

//   given [T : ToJava]: ToJava[Option[T]] = opt => opt.fold("")(_.toJava)
