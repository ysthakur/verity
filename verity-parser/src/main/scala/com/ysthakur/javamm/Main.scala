...
import com.ysthakur.verity.parsing.lexer.{Token, Lexer}
import com.ysthakur.verity.parsing.ast.INode
import com.ysthakur.verity.parsing.parser.Parser
// import com.ysthakur.verity.parsing.parser.Parser
...
object Main /*extends App*/ {
  ...
  def main(args: Array[String]): Unit = {
    ...
    //writer.write("package com.ysthakur.verity.parsing.parser\n\nimport scala.util.parsing.combinator.RegexParsers\n\nclass NewLexer extends RegexParsers {\n")
    writer.write("")
    val tri = "\"\"\""
  ...
  def lex(): Iterable[Token[?]] = {
    val file = new File(
        "C:\\Users\\thaku\\verity-scala\\verity-parser\\src\\test\\resources\\lexertest"
    )
